...
function isNavActive(
  ...
  // Exact match for course home to avoid matching all sub-routes
...
export default function CourseLayout({ children }: { children: ReactNode }) {
  ...
  // Fetch real course data from API; fall back to Zustand mock while loading.
  ...
  const color = apiCourse ? courseColor(apiCourse.id) : (mockCourse?.colorCode ?? "#6366f1");
